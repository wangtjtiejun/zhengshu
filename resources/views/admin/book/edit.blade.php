...
<article class="page-container">
    <form class="form form-horizontal" id="form-book-update">
        {{csrf_field()}}
        <div class="row cl">
            <label for="name" class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>姓名：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text radius" value="{{$result['name']}}" placeholder="" id="name" name="name">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box" style="padding-left: 0px;">
                    <input type="radio" id="sex-1" name="sex" value="男" @if($result["sex"] == "男") checked @endif>
                    <label for="sex-1">男</label>
                </div>
                <div class="radio-box" style="padding-left: 0px;">
                    <input type="radio" id="sex-2" name="sex" value="女" @if($result["sex"] == "女") checked @endif>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <input type="date" class="input-text radius" placeholder="" value="{{$result['birthday']}}" name="birthday" id="birthday">
            </div>
        </div>
        <div class="row cl">
            <label for="card_number" class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>证书编号：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="number" class="input-text radius" value="{{$result['card_number']}}" placeholder="" id="card_number" name="card_number" style="width:200px;">
            </div>
        </div>
        <div class="row cl">
            <label for="id_card" class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>身份证号：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text radius" value="{{$result['id_card']}}" placeholder="" id="id_card" name="id_card">
            </div>
        </div>
        <div class="row cl">
            <label for="grade_work" class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>职业（工种）及等级：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text radius" value="{{$result['grade_work']}}" placeholder="" id="grade_work" name="grade_work">
            </div>
        </div>
        <div class="row cl">
            <label for="llzs_score" class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>理论知识考试成绩：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text radius" value="{{$result['llzs_score']}}" placeholder="" id="llzs_score" name="llzs_score" >
            </div>
        </div>
        <div class="row cl">
            <label for="czjn_score" class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>操作技能考核成绩：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text radius" value="{{$result['czjn_score']}}" placeholder="" id="czjn_score" name="czjn_score" >
            </div>
        </div>
        <div class="row cl">
            <label for="results" class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>评定成绩：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text radius" value="{{$result['results']}}" placeholder="" id="results" name="results">
            </div>
        </div>
        <div class="row cl">
            <label for="card_date" class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>颁证日期：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="date" class="input-text radius" value="{{$result['card_date']}}" placeholder="" id="card_date" name="card_date">
            </div>
        </div>
        <div class="row cl">
            <label for="company" class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>发证单位：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text radius" value="{{$result['company']}}" placeholder="" id="company" name="company">
            </div>
        </div>
        <div class="row cl">
            <label for="paragraph_number" class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>证书流水码所属号段：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text radius" value="{{$result['paragraph_number']}}" placeholder="" id="paragraph_number" name="paragraph_number">
            </div>
        </div>
